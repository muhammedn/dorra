...
<div role="main" class="main">
		...
		<div class="container">
			<div class="row justify-content-end mt-4">
				<div class="col-lg-10 pt-4 mt-4 text-right">
					<h1 class="text-uppercase font-weight-light mt-4 pt-3 text-color-primary">Dorra</h1>
				</div>
			</div>
		</div>
	</section>
	...
	<div class="container">
		...
		<section id="who-we-are" class="mb-4">
			...
			<p class="lead mb-4 mt-4">Founded in 2001 Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra </p>

			<p>Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra </p>
		</section>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<ul class="list list-unstyled list-primary list-borders">
						...
						<li class="pt-2 pb-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="100"><strong class="text-color-primary text-4">2014 - </strong> Dorra creates its new brand</li>
						<li class="pt-2 pb-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="200"><strong class="text-color-primary text-4">2006 - </strong> Dorra opens it doors in Egypt</li>
						...
						<li class="pt-2 pb-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="400"><strong class="text-color-primary text-4">2001 - </strong> Dorra goes into business</li>
					</ul>
				</div>
			</div>
		</section>
				...
				<div class="col-sm-6 text-center">
					<div class="feature-box feature-box-style-4 justify-content-center mt-4 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
						...
						<div class="feature-box-info">
							...
							<p class="mb-4">Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra </p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 text-center">
					<div class="feature-box feature-box-style-4 justify-content-center mt-4 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
						...
						<div class="feature-box-info">
							...
							<p class="mb-4">Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra </p>
						</div>
					</div>
				</div>
			</div>
		...
		<section id="leadership" class="mb-4">
			...
			<div class="row mt-4">
				...
				<div class="col-md-6">
					<span class="thumb-info thumb-info-side-image thumb-info-no-zoom no-borders mb-4">
						<span class="thumb-info-side-image-wrapper p-0">
							<img src="img\team\team-22.jpg" class="img-fluid" alt="" style="width: 160px;">
						</span>
						<span class="thumb-info-caption">
							<span class="thumb-info-caption-text">
								<h5 class="text-uppercase mb-1">Founder Name - <small class="font-weight-light">Founder</small></h5>
								<p class="mb-0">Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra </p>
							</span>
						</span>
					</span>
				...
				<div class="col-md-6">
					<span class="thumb-info thumb-info-side-image thumb-info-no-zoom no-borders mb-4">
						<span class="thumb-info-side-image-wrapper p-0">
							<img src="img\team\team-23.jpg" class="img-fluid" alt="" style="width: 160px;">
						</span>
						<span class="thumb-info-caption">
							<span class="thumb-info-caption-text">
								<h5 class="text-uppercase mb-1">President Name - <small class="font-weight-light">President</small></h5>
								<p class="mb-0">Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra Dorra </p>
							</span>
						</span>
					</span>
