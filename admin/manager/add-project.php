...
include 'init.php';
   ...
   if(isset($_POST['add'])){
         ...
         $stmt = $con->prepare("INSERT INTO project_highlight(p_name , p_desc , add_date,location ,type, generalp,highlight , id_cat  , p_image , p_image2 , p_image3 , p_image4) VALUES(:zname ,:zdesc , now(),:zloca , :ztype , :zgen , :zhigh ,:zcat ,:zimage, :zimage2 , :zimage3 , :zimage4)");
         $stmt->execute(array(
            'zname' => $name,
            'zdesc' => $desc,
            'zhigh' => $high,
