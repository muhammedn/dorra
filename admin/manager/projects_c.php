...
ob_start();
session_start();
$pagetitle = ' DEVELOPMENTS Projects';
         ...
         <main class="main--container">
            <section class="page--header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="page--title h5">CONTRACTING Projects</h2>
                            <ul class="breadcrumb">
                ...
                <div class="panel">
                    ...
                    <div class="records--list" data-title="Projects Listing">
                        <table id="recordsListView">
                            ...
                            <tbody>
                                <?php
                                $stmt = $con->prepare("SELECT project_c.*, category.cat_name AS cat_name  FROM project_c
                                    INNER JOIN category
                                        ON
                                 category.ID = project_c.id_cat");
                               $stmt->execute(array());
                          ...
                          if(isset($_POST['yes'])){
                              ...
                              $stmt = $con->prepare("UPDATE project_c SET highlight = ?  WHERE ID = ? ");
                              $stmt->execute(array($high, $id ));
                               header('Location: projects_c.php');
                               exit();
